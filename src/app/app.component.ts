...
export class AppComponent {
  ...
  iconsList = [
    ...
    { text: 'sonde elenco: configura PA - sospeso', old: 'rfgui-cfg-PA-suspend', new: ['fas fa-link color-red', 'fas fa-unlink color-red']},
    { text: 'sonde elenco: configura PA - ripreso', old: 'rfgui-cfg-PA-resume', new: ['fas fa-link color-green']},
    ...
    { text: 'disattiva', old: 'far fa-times-circle rfgui-disable', new: ['']},
